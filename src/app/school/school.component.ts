...
export class SchoolComponent implements OnInit {
    ...
    public thumbnails: Array<any> = [
        {
            mode: "vertical", src: "assets/images/classroom", title: "Mathematics",
        ...
        {
            mode: "vertical", src: "assets/images/stationary", title: "Physical Development",
        ...
        {
            mode: "vertical", src: "assets/images/crayons", title: "Science",
        ...
        {
            mode: "horizontal left", src: "assets/images/colors", title: "Practical Life Activities",
        ...
        {
            mode: "horizontal right", src: "assets/images/art", title: "Sensorial Development",
        ...
        {
            mode: "horizontal left", src: "assets/images/crayons", title: "Art",
        ...
        {
            mode: "overlay", src: "assets/images/colors", title: "Language",
        ...
        {
            mode: "overlay", src: "assets/images/crayons", title: "Geography, History, Art, Culture",
